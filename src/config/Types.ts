export class Types {
    ...
    static readonly 'IAppConfig' = 'IAppConfig';
    ...
    static readonly 'IRepository_ITaskModel' = 'IRepository<ITaskModel>';
    static readonly 'IRepository_ITimeTriggerModel' = 'IRepository<ITimeTriggerModel>';
    static readonly 'IRepository_IFunctionActionModel' = 'IRepository<IFunctionActionModel>';
    ...
    static readonly 'IBaseBusiness_ITimeTriggerModel' = 'IBaseBusiness<ITimeTriggerModel>';
    static readonly 'IBaseBusiness_IThermostatModel' = 'IBaseBusiness<IThermostatModel>';
    static readonly 'IBaseBusiness_ITaskModel' = 'IBaseBusiness<ITaskModel>';
    static readonly 'IBaseBusiness_IDeviceModel' = 'IBaseBusiness<IDeviceModel>';
    static readonly 'IDeviceBusiness' = 'IDeviceBusiness';
    static readonly 'IBaseBusiness_IActionModel' = 'IBaseBusiness<IActionModel>';
    static readonly 'IBaseBusiness_IHttpActionModel' = 'IBaseBusiness<IHttpActionModel>';
    static readonly 'ThermostatBusiness' = 'ThermostatBusiness';
